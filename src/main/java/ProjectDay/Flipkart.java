...
import wdMethods.SeMethods;
		...
		public void CreateContact() {
			...
			WebElement elesubmenu = locateElement("xpath", "(//a/span[text()='Samsung'])[2]");
			...
			click(elefinalcomp);
			WebElement eleprice1 = locateElement("xpath", "(//div[text()='₹54,999'])[1]");
			String price1 = getText(eleprice1);
			WebElement eleprice2 = locateElement("xpath", "(//div[text()='₹44,999'])[1]");
